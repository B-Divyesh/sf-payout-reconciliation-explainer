# Payout Reconciliation Explainer (`payout-reconciliation-explainer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://payout-reconciliation-explainer.sociobot.in`. Artifact class: `pwa-offline`.
